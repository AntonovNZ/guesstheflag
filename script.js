const flags = [
    ...
    { name: "Central African Republic", image: "https://flagcdn.com/w320/cf.png" },
    ...
    { name: "Congo (Democratic Republic)", image: "https://flagcdn.com/w320/drc.png" },
    ...
    { name: "Czech Republic", image: "https://flagcdn.com/w320/cz.png" },
    ...
    { name: "Micronesia", image: "https://flagcdn.com/w320/fm.png" },
    ...
    { name: "Syria", image: "https://flagcdn.com/w320/sy.png" },
    ...
    { name: "Vatican City", image: "https://flagcdn.com/w320/vt.png" },
...
document.getElementById('submit').onclick = function() {
    ...
    if (guess.toLowerCase() === currentFlag.name.toLowerCase()) {
        streak++;
        resultDiv.textContent = "Correct! It's " + currentFlag.name + "!";
        document.getElementById('streak').textContent = "Current Streak: " + streak;
        document.getElementById('next').style.display = 'inline';
    } else {
        resultDiv.textContent = "Wrong! The correct answer was " + currentFlag.name + ".";
        streak = 0; // Reset the streak on wrong answer
        document.getElementById('streak').textContent = "Current Streak: " + streak;
    }
};
...
// Load the first flag when the page is loaded
